        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form x-data="{ isSubmitting: false }" @submit="isSubmitting = true" method="POST" action="{{ route('properties.update', $property) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="flex items-center justify-end">
                            <x-primary-button class="ml-4" :disabled="isSubmitting">
                                <span x-show="!isSubmitting">{{ __('Update Property') }}</span>
