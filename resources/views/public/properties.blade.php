...
@section('description', 'Browse thousands of rental properties across Rwanda. Find your dream home with our comprehensive property listings.')
...
<div class="bg-gray-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-4">Browse Properties</h1>
            <p class="text-gray-600">Discover thousands of rental properties across Rwanda</p>
        </div>
